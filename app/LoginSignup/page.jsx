...
React.useEffect(() => {
    if (errorParam === "CredentialsSignin") {
        (async () => {
            try {
                await fetch(process.env.NEXT_PUBLIC_API_BASE_URL, { signal: AbortSignal.timeout(3000) });
                setLoginError("Invalid email or password. Please try again.");
            } catch {
                setLoginError("Our servers are currently unavailable. Please try again later.");
            }
    ...
    <div className={styles.mainContainer}>
        ...
        {errorParam === "deactivated" && (
            <div className={styles.deactivatedBanner}>
                ...
                <div>
                    <h4 className={styles.deactivatedTitle}>Account Deactivated</h4>
                    <p className={styles.deactivatedText}>This account has been deactivated and is scheduled for deletion. Contact support to reactivate it.</p>
                </div>
            </div>
        )}
        ...
        {loginError && (
            <div className={styles.deactivatedBanner}>
                ...
                <div>
                    <h4 className={styles.deactivatedTitle}>Sign In Failed</h4>
                    <p className={styles.deactivatedText}>{loginError}</p>
                </div>
            </div>
        )}
                ...
                <form action="submit" onSubmit={handleSubmit} className={styles.form}> 
                    ...
                    <>
                        ...
                        <div className={styles.formInputs}>
                            ...
                            <div className={styles.inputWrapper}>
                                <label htmlFor="emailSignup">Phone Number</label>
                                <div className={styles.inputContainer}>
                                    <span className={styles.inputIcon}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#666666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-user-icon lucide-book-user">
