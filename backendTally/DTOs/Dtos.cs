...
public record SignupDto(string Email, string Name, string Password, string? PhoneNumber, DateTime? TermsAgreedAt);
...
public record OAuthLoginDto(string Email, string Name, string Provider, DateTime? TermsAgreedAt);