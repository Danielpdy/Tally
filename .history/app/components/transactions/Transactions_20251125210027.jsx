...
const Transactions = () => {
    ...
    const filterCounters = (type) => {
        const setCounter = transactions.filter((transaction) => (
            transaction.type === type
        ));

        if (setCounter.length <= 0) return null;

        return setCounter.length;
    }

    const filters = [
        { name: 'Income', icon: '/assets/icons/incomeIcon.svg', count: filterCounters('Income') },
        { name: 'Expense', icon: '/assets/icons/expenseIcon.svg', count: filterCounters('Expense') },
        { name: 'Transfer', icon: '/assets/icons/transferIcon.svg', count: filterCounters('Transfer') },
        { name: 'Loan', icon: '/assets/icons/loanIcon.svg', count: filterCounters('Loan') },
        { name: 'Savings', icon: '/assets/icons/savingsIcon.svg', count: filterCounters('Savings') },
        { name: 'Goal', icon: '/assets/icons/goalIcon.svg', count: filterCounters('Goal')}
    ];
                                ...
                                <div className={styles.balanceCard}>
                                    ...
                                    <div className={styles.cashFlowBreakdown}>
                                        ...
                                        <div className={styles.breakdownItem}>
                                            ...
                                            <span className={styles.incomeText}>${globalEarnings}</span>
                                        </div>
                                        <div className={styles.progressBarIncome}></div>

                                        <div className={styles.breakdownItem}>
                                            <span className={styles.breakdownLabel}>Expenses</span>
                                            <span className={styles.expenseText}>${globalSpendings}</span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ display: 'flex', gap: '24px', marginTop: '8px' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <p style={{ fontSize: '14px', fontWeight: '600', color: '#38BDF8' }}>${global}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
