...
const Transactions = () => {
    ...
    const [currentStepPannel, setCurrentStepPannel] = useState("2");
    const sidePannelRef = useRef(null);

    const steps = {
        SELECT_TYPE,
        SELECT_CATEGORY,
        TRANSACTIONS_DETIALS,
        REVIEW_AND_CONFIRM
    }
    ...
    if ( transactionsNumber <= 0 ) {
        return(
            ...
            <aside ref={sidePannelRef} className={`${styles.aside} ${sidePannelToogle ? styles.visible : ""}`}>
                ...
                <div className={`${styles.asideContent} ${currentStepPannel === steps. ? "" : styles.hidden }`}>
                    ...
                    <div className={styles.transactionGrid}>
                        <div
                            ...
                            onClick={() => nextStepPannel("3", "Income")}
                        >
                        ...
                        <div
                            ...
                            onClick={() => nextStepPannel("3", "Expense")}
                        >
                            <div className={styles.transactionIcon}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div
                            ...
                            onClick={() => nextStepPannel("3", "Transfer")}
                        >
                            <div className={styles.transactionIcon}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div
                            ...
                            onClick={() => nextStepPannel("3", "Savings")}
                        >
                            <div className={styles.transactionIcon}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className={`${currentStepPannel === "3" ? "" : styles.hidden}`}>This is only a test</div>
            </aside>
            </>
        )
    }
