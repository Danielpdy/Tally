...
const Transactions = () => {
    ...
    // TODO: TEMPORARY - Replace with real calculation logic later
    // This should calculate: Weekly Income - Weekly Outflow - Upcoming Bills - Safety Buffer
                            ...
                            <div className={styles.rightColumn}>
                                ...
                                <div className={styles.quickActionsCard}>
                                    ...
                                    <div className={styles.actionsList}>
                                        ...
                                        <Link href="/budget" style={{ textDecoration: 'none', width: '100%' }}>
