...
const TransactionsSidePannel = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSelectType = (type) => {
        ...
        setCurrentStepP(steps.SELECT_CATEGORY);
        setStepNumber(2);
    };
                ...
                <div className={`${styles.asideContent} ${currentStepPannel === steps.TRANSACTIONS_DETAILS ? "" : styles.hidden}`}>
                    <div className={styles.transactionDetailsContainer}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <div className={styles.dropdownWrapper}>
                                <button
                                    ref={accountDropdown.dropdownRef}
                                    className={`${styles.dropdownButton} ${accountDropdown.isOpen ? styles.open : ""}`}
