...
const Transactions = () => {
    ...
    const { globalIncome, globalExpenses, globalNet } = useMemo(() => {
                    ...
                    <div className={styles.transactionsContent}>
                        ...
                        <section className={styles.financialSummary}>
                            ...
                            <div className={`${styles.summaryBadge} ${styles.expenseBadge}`}>
                                ...
                                <span className={styles.summaryAmount}>${globalSpenf}</span>
                            </div>
                                ...
                                <div className={styles.balanceCard}>
                                    ...
                                    <div className={styles.cashFlowBreakdown}>
                                        ...
                                        <div className={styles.breakdownItem}>
                                            ...
                                            <span className={styles.expenseText}>${globalExpenses}</span>
                                        </div>
