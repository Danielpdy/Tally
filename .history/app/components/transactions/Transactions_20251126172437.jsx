...
const Transactions = () => {
    ...
    const [filteredByBtn, setFilteredByBtn] = useState(false);
    ...
    const filteredTransactions = useMemo(() => {
        if (!searchQuery && !filterCount) return transactions;
        ...
        return setTempTransactions(transactions.filter(t => t.description.toLowerCase().includes(query)
    ...
    const filterButton = (filterName) => {
        ...
        return transactions.filter(t => t.type === filterName);
    }
