...
const Transactions = () => {
    ...
    async function fetchTransactions() {
        ...
        const totalIncome = data.reduce((total, t) => (
            t.type === "Income" ? total + t.amount : sum, 0
        ));
    ...
    function calculateGlobalTotals (totalName, data, type, setName) {
        totalName = data.reduce((sum, t) => (
            t.type === type ? sum + t.amount : sum, 0
        ));
