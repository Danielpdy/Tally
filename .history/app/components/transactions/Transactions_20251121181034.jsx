...
import { trackSynchronousRequestDataAccessInDev } from '@node_modules/next/dist/server/app-render/dynamic-rendering';
...
const Transactions = () => {
    ...
    const handleAddTransaction = async (newTransaction) => {
        ...
        try {
            ...
            setIsAdded(trackSynchronousRequestDataAccessInDev)
