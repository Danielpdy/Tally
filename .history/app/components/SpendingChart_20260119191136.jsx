...
const SpendingChart = ({ preview, content = [], recurringBillsDueThisWeek = [], recurringBillsOverdueThisWeek = [] }) => {
    ...
    const currentWeekData = useMemo(() => {
      ...
      const dueBillTransactions = Array.isArray(recurringBillsDueThisWeek) 
      ...
      const overdueBillTransactions = Array.isArray(recurringBillsOverdueThisWeek) 
        ? recurringBillsOverdueThisWeek.map((bill) => ({
        type: "Expense",
        amount: bill.amount,
        description: bill.name,
        date: bill.dayOfMonth,
        category: "recurring bill overdue"
      })) : [];

      return [...weekTransactions, ...dueBillTransactions, ...overdueBillTransactions];
