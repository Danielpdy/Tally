...
const Dashboard = () => {
    ...
    const [billsOverdueThisWeek, setBillsOverdue] = useState([]);
    ...
    const fetchBillsDueThisWeek = async () => {
        ...
        setBillsDueThisWeek(billsDueThisWeek);
    };

    const fetchBillsOverdueThisWeek = async () => {
        const billsOverdueThisWeek = await GetBillsOverdueThisWeek(session.accessToken);
    }
            ...
            <div className={styles.dashboardPage}>
                ...
                <div className={styles.mainGrid}>
                    ...
                    <div className={styles.leftColumn}>
                        ...
                        <SpendingChart preview={false} content={transactionsData} recurringBillsDueThisWeek={billsDueThisWeek}/>
