...
const Budgets = () => {
  ...
  const addBillStatus = useMemo(() => {
    if (recurringBills.l === 0 || !billsDueThisWeekIds || !billsOverdueThisWeekIds) return;
    ...
    setRecurringBills(updatedBills);
  }, [billsDueThisWeekIds, billsOverdueThisWeekIds, recurringBills])
