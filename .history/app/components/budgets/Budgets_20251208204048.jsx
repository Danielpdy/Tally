...
const Budgets = () => {
  ...
  const handleAddBill = async (e) => {
    ...
    if (!billForm.name || !billForm.amount || !billForm.dayOfMonth) reur
        ...
        <div className={styles.twoColumnLayout}>
          ...
          <div className={styles.rightColumn}>
            ...
            <div className={styles.recurringBillsCard}>
              ...
              {isSubmitting && (
                <div>
                  <p>Submitting new bill...</p>
                </div>
              )}

              {submitError && (
                <div>
                  <p>Error submitting new bill</p>
                </div>
              )}

              {!isLoadingBill && !isErrorBill && !isSubmitting && !submitError && recurringBills.length > 0 && (
                <>
