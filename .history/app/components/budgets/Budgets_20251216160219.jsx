...
const Budgets = () => {
  ...
  const [safeToSpendAmount, setSafeToSpendAmount] = useState();
  ...
  /*const weeklyEarnings = () => {
    ...
    setSafetyBuffer((bufferPercent / 100) * result);
    setEarnings(result);
  };
  ...
  const calculateSafeToSpend = () => {
    ...
    const buffer = (bufferPercent / 100) * tota
    setSafetyBuffer((bufferPercent / 100) * totalEarnings);
    ...
    setSafeToSpendAmount(totalEarnings - totalSpendings - totalBillsDue - )
