...
const Budgets = () => {
  ...
  const handleAddBillPayment = async (recurringBillId) => {
    ...
    try{
      ...
      setBillsDueThisWeekIds((prev) => prev.filter(bill => bill))
  ...
  const percentageBillsCoverage = useMemo(() => {
    ...
    const getBillStatus = (billId) => {
       console.log(`Checking bill ${billId}:`, {
    overdue: billsOverdueThisWeekIds,
    due: billsDueThisWeekIds,
    paid: billsPaidThisWeekIds
  });
