...
const Budgets = () => {
    ...
    const [recurringBills, setBills] = useState([]);
                        ...
                        <div className={styles.breakdownList}>
                            {isLoading && (
                                <div className={styles.loadingContainer}>
                                    ...
                                    <p className={styles.loadingText}>Loading your budget data...</p>
                                </div>
                            )}
                            {isError && (
                                <div className={styles.errorContainer}>
                                    ...
                                    <button className={styles.retryButton} onClick={getTransactions}>
                                        Retry
                                    </button>
                                </div>
                            )}
                            ...
                            <div className={`${styles.breakdownItem} ${styles.spending}`}>
                                ...
                                <p className={styles.breakdownAmount}>${weeklySpendings}</p>
                            </div>
            ...
            <div className={styles.modalBox}>
                ...
                <div className={styles.modalContent}>
                    <div className={styles.modalFormGroup}>
                        <label htmlFor="BillName" className={styles.modalLabel}>Bill Name</label>
                        <input type="text" className={styles.modalInput} placeholder='e.g., Netflix' />
                    </div>
                    <div className={styles.modalFormGroup}>
                        <label htmlFor="Amount" className={styles.modalLabel}>Amount</label>
                        <input type="number" className={styles.modalInput} placeholder='0.00'/>
                    </div>
                    <div className={styles.modalFormGroup}>
                        <label htmlFor="DueDate" className={styles.modalLabel}>Day of Month (1-31)</label>
                        <input type="text" className={styles.modalInput} placeholder='15'/>
                        <p className={styles.modalHintText}>The day each month when this bill is due</p>
                    </div>
                    <div className={styles.modalFormGroup}>
                        <label htmlFor="Category" className={styles.modalLabel}>Category (Optional)</label>
                        <input type="text" className={styles.modalInput} placeholder='e.g., Entertainment, Utilities'/>
                    </div>
                </div>
