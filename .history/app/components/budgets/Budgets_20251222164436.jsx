...
const Budgets = () => {
  ...
  const handleAddBudgetGoal = async (e) => {
    ...
    if (budgetAmount < spendings) {
      return alert('Your current spendings for this week are already higher than your b')
    }
          ...
          <div className={styles.leftColumn}>
            ...
            <div className={styles.budgetSettingsCard}>
              ...
              <div className={styles.settingsForm}>
                ...
                {/* Weekly Budget Goal */}
                <form onSubmit={ isBudgetGoal ? "" : handleAddBudgetGoal} className={styles.settingGroup}>
