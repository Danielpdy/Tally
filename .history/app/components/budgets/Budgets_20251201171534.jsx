    ...
    return (
        ...
        <div>
            ...
            <div>
                ...
                <div>
                    <label htmlFor="DueDate">Day of Month (1-31)</label>
                    <input type="text" placeholder='15'/>
                    <p>The day each month when this bill is due</p>
                </div>
                <div>
                    <label htmlFor="Category">Category (Optional)</label>
                    <input type="text" placeholder='e.g., Entertainment, Utilities'/>
                </div>
                <div>
