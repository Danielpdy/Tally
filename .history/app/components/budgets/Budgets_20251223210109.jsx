...
const Budgets = () => {
  ...
  useEffect(() => {
    if (!spendings || !budgetGoal) return
    setCurrentSpendingPercent((spendings / budgetGoal) * 100);
  ...
  const fetchBudgetGoal = async () => {
    try {
      ...
      setShowBudget(true);
      setCurrentSpendingPercent((spendings / data.budgetGoal.targetAmount) * 100);
    } catch (error) {
      console.error(error);
    }
  }
                      ...
                      <div className={styles.spendingProgress}>
                        ...
                        <div className={styles.progressBar}>
                          <div
                            ...
                            style={{ width: `${currentSpendingPercent.toFixed(2)}%` }}
                          ></div>
                        </div>
                      </div>
